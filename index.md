---
---
<section class="hero" style="background-image: url('images/hero.jpg'); background-size: cover; background-position: center; width: 100vw; height: 100vh; color: white; display: flex; align-items: center; justify-content: center; text-align: center;">
  <div class="container">
    ...
    <a href="#our-projects" class="button primary" style="color: white; border: 2px solid white; padding: 10px 20px; text-decoration: none;">Explore Our Work</a>
  </div>
</section>
