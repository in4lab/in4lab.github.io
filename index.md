...
<section class="hero" style="position: relative; background-image: url('images/hero.jpg'); background-size: cover; background-position: center; width: 100vw; height: 100vh; overflow: hidden; margin: 0; padding: 0;">
  ...
  <div style="position: relative; z-index: 2; width: 100%; height: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; color: #fff; padding: 0 5vw;">
    <h1 style="font-size: 3.5rem; font-weight: bold; margin-bottom: 20px;">WELCOME TO INFOLAB!</h1>
    <p style="font-size: 1.3rem; max-width: 900px; margin-bottom: 20px;">
    ...
    <a href="#our-projects" style="background-color: transparent; color: white; border: 2px solid white; padding: 12px 30px; text-decoration: none; font-weight: bold; border-radius: 5px; transition: all 0.3s;">
      Explore Our Work
    </a>
  </div>
</section>
